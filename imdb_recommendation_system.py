...
def cosine_similarity_scratch(X, Y=None):
    if Y is None:
        Y = X
    ...
    # calculate the product of the L2 norms
    norms_product = np.outer(X_norms, Y_norms)
...
similarities = cosine_similarity_scratch(new_matrix)
